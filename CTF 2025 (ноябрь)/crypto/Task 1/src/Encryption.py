...
input_data_path = "C:\\CTF Tasks\\Task 1\\Answer\\data.dump"
output_data_path = "C:\\CTF Tasks\\Task 1\\Condition\\encrypted_data.dump"
...
with open(input_data_path, 'rb') as input_data:
    ...
    with open(output_data_path, 'wb') as output_data:
        ...
        for i in range(start_sector_number, final_sector_number):
            ...
            output_data.write(cipher.encrypt(data))                               #Шифруем и записываем сектор
